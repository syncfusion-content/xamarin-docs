---
layout: post
title: Getting Started with Xamarin Masked Entry control | Syncfusion<sup>®</sup>
description: Learn here about getting started with Syncfusion<sup>®</sup> Xamarin Masked Entry (SfMaskedEdit) control, its elements and more.
platform: xamarin
