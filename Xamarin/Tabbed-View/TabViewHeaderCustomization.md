...
When you set the `VisibleHeaderCount` to -1, you get all the tab items in a single view based on the width of the visible area in the control and the tab count.
