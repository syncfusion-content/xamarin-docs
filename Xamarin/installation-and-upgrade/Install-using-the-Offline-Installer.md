...
7.	Click Proceed.
	...
	N> The Completed screen is displayed once the Xamarin platform is installed. If any version is selected to uninstall, The completed screen will display both install and uninstall status.
...
9. Click Finish. Syncfusion Xamarin platform is installed in your system.
