...
>**NOTE**
* `AppointmentIndicatorCount` support applicable only for XForms Android, iOS platforms.
* `AppointmentDisplayCount` support applicable only for XForms UWP(Desktop) platform.
