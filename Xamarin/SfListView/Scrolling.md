 ...
 * When the `ScrollToRowIndex` is set as `MakeVisible`, the scrolling doesn't reach the [ScrollToPosition](https://help.syncfusion.com/cr/cref_files/xamarin/Syncfusion.SfListView.XForms~Syncfusion.ListView.XForms.ScrollToPosition.html) to end for the very first time.
