---
layout: post
title: Display mode in Xamarin Segmented Control | Syncfusion<sup>®</sup>
description: Learn here all about Display mode support in Syncfusion<sup>®</sup> Xamarin Segmented Control (SfSegmentedControl) and more.
platform: Xamarin
