...
You can also refer to the [**Xamarin Mac installer**](https://help.syncfusion.com/xamarin/installation/install-using-the-web-installer) links for step-by-step installation guidelines.	