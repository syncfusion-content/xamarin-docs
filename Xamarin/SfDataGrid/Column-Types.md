...
You can wrap the record cell velue when the text for the record cells exceeds the content area by setting `GridColumn.LineBreakMode` as `LineBreakMode.WordWrap` 
