---
layout: post
title: Customization in Xamarin Chips control | Syncfusion<sup>®</sup>
description: Learn about Customization support in Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> Xamarin Chips control, its elements and more.
platform: xamarin
control: Chips
documentation: ug
---
...
N> The default value of [`Command`](https://help.syncfusion.com/cr/xamarin/Syncfusion.XForms.Buttons.SfButton.html#Syncfusion_XForms_Buttons_SfButton_Command) is [`null`].
