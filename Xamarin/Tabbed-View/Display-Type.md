---
layout: post
title: Display Type in Xamarin Tabbed View control | Syncfusion<sup>®</sup>
description: Learn here all about Display Type support in Syncfusion<sup>®</sup> Xamarin Tabbed View (SfTabView) control and more.
platform: Xamarin
control: TabView
documentation: ug
---
