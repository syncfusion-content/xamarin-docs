---
layout: post
title: Messages in Xamarin Chat control | Syncfusion
description: Learn here all about Messages support in Syncfusion Xamarin Chat (SfChat) control, its elements and more.
platform: xamarin
control: SfChat
documentation: ug
---
