...
N> SfChat does not support LoadMore when [SfChat.ShowTimeBreak](https://help.syncfusion.com/cr/xamarin/Syncfusion.XForms.Chat.SfChat.html#Syncfusion_XForms_Chat_SfChat_ShowTimeBreak) is enabled. Because SfListView has [limitation](https://help.syncfusion.com/xamarin/listview/loadmore#limitations) that [LoadMoreOption.Auto](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.LoadMoreOption.html) or [LoadMoreOption.AutoOnScroll](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.LoadMoreOption.html) works only when [LoadMorePosition.Bottom](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.LoadMorePosition.html) is enabled.
