...
layout: post
title: Tick Setting in Xamarin Circular Gauge control | Syncfusion<sup>&reg;</sup>
description: Learn here all about Tick Setting support in Syncfusion<sup>&reg;</sup> Xamarin Circular Gauge (SfCircularGauge) control and more.
platform: xamarin
...
[How to set ticks and customize its position in circular gauge](https://support.syncfusion.com/kb/article/7341/how-to-set-ticks-and-customize-its-position-in-circular-gauge)
