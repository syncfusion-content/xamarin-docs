...
description: Learn here about getting started with Syncfusion in Xamarin Badge View control, its elements and more.
platform: xamarin
control: SfBadgeView
documentation: ug
---

# Getting Started with Xamarin Badge View
