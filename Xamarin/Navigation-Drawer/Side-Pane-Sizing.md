---
layout: post
title: Setting Sliding Panel size in Xamarin Navigation Drawer control | Syncfusion
...
documentation: ug
---
# Setting Sliding Panel size in Xamarin Navigation Drawer (SfNavigationDrawer)
