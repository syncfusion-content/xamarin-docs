---
layout: post
title: Working with ICalcData | Xamarin.Forms | Syncfusion
description: Explains about the computation in Xamarin.Forms ICalcData
platform: xamarin
control: Calculate
documentation: ug
---
...
For more reference, refer [here](https://help.syncfusion.com/xamarin/calculate/getting-started#cross-sheet-reference).
