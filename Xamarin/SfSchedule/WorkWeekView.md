...
TimeIntervalHeight will be adjusting automatically based on the StartTime and EndTime value of the `WorkWeekLabelSettings` in schedule. When, set the time interval height as -1 timeslots will arranged automatically with in the screen height.
