...
layout: post
title: Position customization of Syncfusion<sup>®</sup> Badge view for Xamarin.Forms
description: This section explain about how to set Syncfusion<sup>®</sup> badge view position customization in Xamarin.Forms platform
platform: xamarin
control: SfBadgeView
documentation: ug
