...
SfDataGrid allows you to customize style of the individual cells and text of the SfDataGrid based on your requirement in the following ways. 
...
Styling can be applied to a particular cell based on the property `RowIndex` and `ColumnIndex` in `QueryCellStyleEventArgs` of the `QueryCellStyle` event
...
Styling can be applied to a particular cell based on the property `CellValue` in `QueryCellStyleEventArgs` of the `QueryCellStyle` event
...
Styling can be applied to a particular row Based on the property `RowIndex` in `QueryRowStyleEventArgs` of the `QueryRowStyle` event
...
Styling can be applied to a particular row based on the property `RowData` in `QueryRowStyleEventArgs` of the `QueryRowStyle` event
