---
layout : post
title: UIVirtualization in Xamarin Carousel View control | Syncfusion<sup>®</sup>
description: Learn here all about UIVirtualization support in Syncfusion<sup>®</sup> Xamarin Carousel View (SfCarousel) control and more.
platform : xamarin
control : Carousel
documentation : ug
---
