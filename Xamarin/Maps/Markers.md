...
`MarkerItemsSource` is recommended when using the custom map markers that are inherited from `MapMarker` and can only be used to assign markers in code behind. Use `Markers` property for the layer to add markers from XAML page.

{% highlight xaml %}
   <ResourceDictionary>
            <DataTemplate x:Key="selectedMarker">
                <StackLayout  Margin="50,0,0,0"  Orientation="Vertical" HorizontalOptions="End" VerticalOptions="Center" >
                    <Image Source="pin.png" Scale="1" Aspect="AspectFit " HorizontalOptions="Center" VerticalOptions="Center"  HeightRequest="35" WidthRequest="25" />
                    <Grid Margin="50,0,0,0">
                        ...
                        <Grid Grid.Column="0" Margin="0" HorizontalOptions="Start" VerticalOptions="Start" BackgroundColor="#FFFF4411" >
                            <Grid.RowDefinitions>
                            ...
                            <Grid  Grid.Row="0" HorizontalOptions="Start" VerticalOptions="Start">
                                ...
                                <Label FontSize="30" FontFamily="Segoe UI" WidthRequest="40"   Text="{Binding CurrentTemperature}" HorizontalOptions="Start" VerticalOptions="Start" TextColor="White"/>
                                <Label Text="&#186;" Grid.Column="1" FontSize="13" WidthRequest="10"   TextColor="White" HorizontalOptions="Start" VerticalOptions="Start"/>
                            </Grid>
                            <Grid Grid.Row="1"  HorizontalOptions="Start"   VerticalOptions="Start">
                                   <Grid.ColumnDefinitions>
                                    ...
                                    <Label FontSize="12"  FontFamily="Segoe UI" Text="{Binding AverageHighTemperature}"  HorizontalOptions="Start" VerticalOptions="Start"  TextColor="White"/>
                                    <Label Text="&#186;" Grid.Column="1" FontSize="8" TextColor="White" HorizontalOptions="Start" VerticalOptions="Start"/>
                                    <Label  Grid.Column="2" FontFamily="Segoe UI" Text="/" HorizontalOptions="Start" VerticalOptions="Start" TextColor="White" FontSize="10"/>
                                    <Label FontSize="12" Grid.Column="3" FontFamily="Segoe UI"  Text="{Binding AverageLowTemperature}" HorizontalOptions="Start" VerticalOptions="Start" TextColor="White"/>
                                    <Label Text="&#186;" Grid.Column="4" FontFamily="Segoe UI" FontSize="10" TextColor="White" HorizontalOptions="Start" VerticalOptions="Start"/>
                            </Grid>
                        </Grid>
                        <Grid Grid.Column="1"  Margin="-6,0,0,0" BackgroundColor="LightGreen" HorizontalOptions="Start"  >
                            <Grid.RowDefinitions>
                                <RowDefinition Height="30"/>
                                <RowDefinition Height="20"/>
                            </Grid.RowDefinitions>
                            <Label WidthRequest="100"  FontFamily="Segoe UI" Text="{Binding Label}" FontSize="20" HorizontalOptions="Start" VerticalOptions="Start" TextColor="Black" />
                            <Label WidthRequest="100"  Grid.Row="1"  TextColor="Black" FontFamily="Segoe UI" Text="{Binding WeatherDescription}" HorizontalOptions="Start" FontSize="15" VerticalOptions="Start"/>
                        </Grid>
                    </Grid>
                </StackLayout>
            </DataTemplate>
       ...
       <maps:SfMaps x:Name="sfmap">
        <maps:SfMaps.Layers >
            <maps:ShapeFileLayer x:Name="shapeLayer" Uri="world1.shp" MarkerItemsSource="{Binding WeatherCollection}" MarkerTemplate="{StaticResource selectedMarker }" >
...
{% highlight c# %}
    ...
    public partial class MainPage : ContentPage
    {
		...
		InitializeComponent();
            ...
            layer.MarkerTemplate = Resources["selectedMarker"] as DataTemplate;
            layer.MarkerItemsSource = viewModel.WeatherCollection;
            map.Layers.Add(layer);
            this.Content = map;
        }
    }

    public class Weather: MapMarker
    ...
    {
        public List<Weather> WeatherCollection {get;set;  }

        public ViewModel()

        {

            WeatherCollection = new List<Weather>();

            WeatherCollection.Add(new Weather() {CurrentTemperature = 44, AverageHighTemperature = 63, AverageLowTemperature = 46, Label = "Chicago",  WeatherDescription = "Partly Cloudy", Latitude = "41.878113N", Longitude = "-87.629799E" });

            WeatherCollection.Add(new Weather() {  CurrentTemperature = 77, AverageHighTemperature = 89, AverageLowTemperature = 75, Label = "Chennai",  WeatherDescription = "Rainy", Latitude = "13.082680N", Longitude = "80.270721E" });

            WeatherCollection.Add(new Weather() {  CurrentTemperature = 70, AverageHighTemperature = 70, AverageLowTemperature = 57, Label = "Tokyo", WeatherDescription = "Partly Cloudy", Latitude = "35.6833N", Longitude = "139.7667E" });

            WeatherCollection.Add(new Weather() { CurrentTemperature = 55, AverageHighTemperature = 47, AverageLowTemperature = 38, Label = "Moscow",  WeatherDescription = "Clear", Latitude = "55.7517N", Longitude = "37.6178E" });

            WeatherCollection.Add(new Weather() { CurrentTemperature = 53, AverageHighTemperature = 69, AverageLowTemperature = 54, Label = "Cape Town",  WeatherDescription = "Partly Cloudy", Latitude = "33.9767S", Longitude = "18.4244E" });

            WeatherCollection.Add(new Weather() {  CurrentTemperature = 64, AverageHighTemperature = 69, AverageLowTemperature = 56, Label = "Anchorage", WeatherDescription = "Cloudy", Latitude = "61.1919N", Longitude = "149.7621W" });

            WeatherCollection.Add(new Weather() {CurrentTemperature = 91, AverageHighTemperature = 95, AverageLowTemperature = 74, Label = "Panama",  WeatherDescription = "Fair", Latitude = "8.5380N", Longitude = "84.7821W" });

            WeatherCollection.Add(new Weather() {  CurrentTemperature = 61, AverageHighTemperature = 76, AverageLowTemperature = 59, Label = "Sao Paulo",  WeatherDescription = "Fair", Latitude = "23.5000S", Longitude = "46.6167W" });

            WeatherCollection.Add(new Weather() { CurrentTemperature = 70, AverageHighTemperature = 85, AverageLowTemperature = 72, Label = "Cairo",WeatherDescription = "Cloudy", Latitude = "33.2262E", Longitude = "30.0566N" });

            WeatherCollection.Add(new Weather() { CurrentTemperature = 70, AverageHighTemperature = 85, AverageLowTemperature = 72, Label = "Melbourne", WeatherDescription = "Cloudy", Latitude = "35.0833S", Longitude = "142.0667E" });
        }
...
![Marker Items Source Image](Images/MarkerItemsSource.png)
