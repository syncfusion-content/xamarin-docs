---
layout: post
title: Markers in Xamarin.Forms Maps control | Syncfusion<sup>&reg;</sup>
description: Learn here all about Markers support in Syncfusion<sup>&reg;</sup> Xamarin Maps (SfMaps) control, its elements and more.
platform: xamarin
control: SfMaps
documentation: ug
---
