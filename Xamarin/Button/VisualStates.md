...
N>The visual states `Checked` and `Unchecked` are only updated when a [toggle type](https://help.syncfusion.com/xamarin/button/gettingstarted#toggle-button) is used for [`SfButton`](https://help.syncfusion.com/cr/xamarin/Syncfusion.Buttons.XForms~Syncfusion.XForms.Buttons.SfButton.html).
