...
![Export DataGrid to PDF format with group summary rows](SfDataGrid_images/PDF/GroupSummaryPdf.png)
...
![Export DataGrid to PDF format with customized row height](SfDataGrid_images/PDF/ColumnWidth.png)
