...
The below code illustrates how to create a SfDataGrid along with `ExportToExcel` and `ExportToPdf` buttons.
...
private void pdfExport_HeaderAndFooterExporting(object sender, PdfHeaderFooterEventArgs e)
{
    ...
    var imagestream = assmbely.GetManifestResourceStream("DataGridDemo.SyncfusionLogo.jpg");
...
{% highlight c# %}
// Need to define as Interfaces in-order to use it in platform wise using Dependency Service
