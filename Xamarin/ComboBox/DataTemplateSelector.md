---
layout: post
title: DataTemplateSelector in Xamarin ComboBox control | Syncfusion<sup>®</sup>
description: Learn here all about DataTemplateSelector support in Syncfusion<sup>®</sup> Xamarin ComboBox (SfComboBox) control and more.
platform: Xamarin
control: SfComboBox
documentation: ug
---
