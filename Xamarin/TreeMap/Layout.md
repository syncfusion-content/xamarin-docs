---
layout: post
title: Layout in Xamarin TreeMap control | Syncfusion<sup>&reg;</sup>
description: Learn here all about Layout support in Syncfusion<sup>&reg;</sup> Xamarin TreeMap (SfTreeMap) control, its elements and more.
platform: xamarin
control: TreeMap
documentation: ug
---
