---
layout: post
title: Item Reordering in Xamarin ListView control | Syncfusion
description: Learn here all about Item Reordering support in Syncfusion Xamarin ListView (SfListView) control and more.
platform: xamarin
control: SfListView
documentation: ug
---
...
[How to drag and drop an item from one to another listview in Xamarin.Forms](https://support.syncfusion.com/kb/article/9669/how-to-drag-and-drop-an-item-from-one-to-another-listview-in-xamarin-forms)                                                                                                                                                                                                                                                              
[How to show or hide the drag indicator like iOS listview](https://support.syncfusion.com/kb/article/8719/how-to-show-or-hide-the-drag-indicator-like-ios-listview)                                                                                                                                                     
[How to retrieve the dragged item index in ViewModel command with the Prism framework in Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/9883/how-to-retrieve-the-dragged-item-index-in-viewmodel-command-with-the-prism-framework-in)                                                                                                                                                                                  
[How to show or hide drag indicator based on the DragStartMode in Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/9906/how-to-show-or-hide-drag-indicator-based-on-the-dragstartmode-in-xamarin-forms-listview)                                    
[How to get the dropped item group in Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/9964/how-to-get-the-dropped-item-group-in-xamarin-forms-listview-sflistview)                                                                                                                                                                                                                         
[How to handle button action of ListView item when dragging in Xamarin.Forms (SfListView)](https://support.syncfusion.com/kb/article/10122/how-to-handle-button-action-of-listview-item-when-dragging-in-xamarin-forms-sflistview)
