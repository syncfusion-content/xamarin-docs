---
layout : post
title: Linear Arrangement in Xamarin Carousel View control | Syncfusion<sup>®</sup>
description: Learn here all about Linear Arrangement support in Syncfusion<sup>®</sup> Xamarin Carousel View (SfCarousel) control and more.
platform : xamarin
control : Carousel
documentation : ug
---
