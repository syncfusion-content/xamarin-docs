...
N> Though the [`Content`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.RangeNavigator.XForms.SfDateTimeRangeNavigator~Content.html) property’s data type is View and it can accept any View as its value, but currently `SfDateTimeRangeNavigator` can accept only SfChart as its content.
