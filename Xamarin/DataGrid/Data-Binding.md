...
[How to resolve "Cannot resolve reference `Xamarin.Android.Support.Interpolate'" in Xamarin.Forms Android projects](https://support.syncfusion.com/kb/article/9422/how-can-i-fix-cannot-resolve-reference-xamarinandroidsupportinterpolator)
...
[How to apply the custom assemblies when configured the project with Syncfusion NuGet packages](https://support.syncfusion.com/kb/article/7348/how-to-apply-the-custom-assemblies-when-configured-the-project-with-syncfusion-nuget)
...
[How to resolve "Expecting class path separator ';' before" error in Xamarin.Forms.Android](https://support.syncfusion.com/kb/article/6698/how-to-resolve-expecting-class-path-separator-before-error-in-xamarinforms-datagrid)
