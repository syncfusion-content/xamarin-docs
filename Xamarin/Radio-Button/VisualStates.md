---
layout: post
title: Visual States in Xamarin Radio Button control | Syncfusion<sup>®</sup>
description: Learn here all about Visual States support in Syncfusion<sup>®</sup> Xamarin Radio Button (SfRadioButton) control and more.
platform: xamarin
