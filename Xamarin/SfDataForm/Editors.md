...
{% endhighlight %}
{% endtabs %}
![You can set Append as one of display mode in AutoComplete to display all the matchesin Xamarin.Forms DataForm](SfDataForm_images/DataForm_AutoCompleteAppend.png)
