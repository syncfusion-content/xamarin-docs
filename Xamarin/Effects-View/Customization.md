---
layout: post
title: Customization in Xamarin Effects View control | Syncfusion<sup>®</sup>
description: Learn here all about Customization support in Syncfusion<sup>®</sup> Xamarin Effects View (SfEffectsView) control and more.
platform: xamarin
