...
I> After adding the reference, currently, an additional step is required for iOS and UWP projects. We need to create an instance of the `SfLinearGaugeRenderer` in iOS and UWP projects as shown in this [KB article.](https://www.syncfusion.com/kb/7144)
...
ShowRim property is a Boolean property which is used to enable or disable Rim feature in linearGauge
...
{% highlight xaml %}
        ...
        <linear:SfLinearGauge x:Name="linearGauge">
          <linear:SfLinearGauge.Scales>
	  				<linear:LinearScale x:Name="scale" ShowRim = "False">
                    </linear:LinearScale>
	      </linear:SfLinearGauge.Scales>			
	    </linear:SfLinearGauge>	 
