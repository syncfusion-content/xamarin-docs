...
N> The line exists between two data points. It considered as a single data point for their color customization. This is the default behavior of the line kind of series.
