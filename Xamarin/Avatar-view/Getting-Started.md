---
layout: post
title: Getting Started with Xamarin Avatar View control | Syncfusion
description: Learn here about getting started with Syncfusion Xamarin Avatar View (SfAvatarView) control, its elements and more.
platform: xamarin
