...
Series will use the colors from `CustomBrushes` property if the `ColorModel.Palette` property of series is set to `Custom`. You add the custom colors to [`ChartColorCollection`].
