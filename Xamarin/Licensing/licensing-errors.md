...
**Error Message:**The included Syncfusion license ({Registered Version}) is invalid for version {Required version}. Please refer to this help topic(https://help.syncfusion.com/xamarin/licensing/licensing-errors#version-mismatch) for more information.
