...
Icon fonts are just fonts. However, instead of containing letters or numbers, they contain symbols and glyphs. Icons fonts are reduces the stretch issues and aspect ratios. Here we have created icons using `Metro studio`.
...
![](images/radialMenuItemsIconFont.png)
...
![](images/radialMenuItemCustomView.png)
