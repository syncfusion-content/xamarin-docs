...
<dd>In addition, you need to install the 1.68.0 version of nuget [SkiaSharp.Views.Forms](https://www.nuget.org/packages/SkiaSharp.Views.Forms/1.68.0) in all projects</dd>
</dl>
