---
layout: post
title: Orientation in Xamarin Range Slider control | Syncfusion<sup>®</sup>
description: Learn here all about Orientation support in Syncfusion<sup>®</sup> Xamarin Range Slider (SfRangeSlider) control and more.
platform: Xamarin
