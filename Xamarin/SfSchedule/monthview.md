...
AgendaTemplateSelector can be used to choose a DataTemplate at runtime based on the value of a data-bound to agenda appointment property through `AgendaItemTemplate`. It provides multiple DataTemplates to be enabled for Agenda appointments, to customize the appearance of particular Appointment.
