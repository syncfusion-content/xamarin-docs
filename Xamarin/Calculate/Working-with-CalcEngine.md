---
layout: post
title: Working with CalcEngine | Xamarin.Forms | Syncfusion
description: Description about properties, methods maintained in Xamarin.Forms CalcEngine
platform: xamarin
control: Calculate
documentation: ug
---
...
A method that parses and computes the string formula passed in. For more reference, see [here](https://help.syncfusion.com/xamarin/calculate/parse-and-compute#parseandcomputeformula).

### ParseFormula

A method that parses the string formula passed in. For more reference, see [here](https://help.syncfusion.com/xamarin/calculate/parse-and-compute#parse-formula).

### ComputeFormula

A method that computes a parsed formula. For more reference, see [here](https://help.syncfusion.com/xamarin/calculate/parse-and-compute#computeformula).

### RegisterGridAsSheet

 A method that registers an `ICalcData` object so it can be referenced in a formula from another `ICalcData` object. For more reference, see [here](https://help.syncfusion.com/xamarin/calculate/getting-started#cross-sheet-reference).
