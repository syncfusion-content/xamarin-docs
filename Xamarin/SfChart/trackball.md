...
* [`None`] – Trackball is not visible when setting activation mode as `None`. It can be activated only by using [`Show`](https://help.syncfusion.com/cr/cref_files/xamarin/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartTrackballBehavior~Show.html) method.
