---
layout: post
title: Downloading Syncfusion<sup>®</sup> Xamarin web installer - Syncfusion<sup>®</sup>
description: Learn here about the how to download Syncfusion<sup>®</sup> Xamarin web installer from our syncfusion<sup>®</sup> website with license.
platform: xamarin
...
# Downloading Syncfusion<sup>®</sup> Xamarin web installer
...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> Xamarin web installer.
...
1. Syncfusion<sup>®</sup> licensed products will be available in the [License & Downloads](https://www.syncfusion.com/account/downloads) page under your registered Syncfusion account.
...
8. After downloading, the Syncfusion<sup>®</sup> Xamarin web installer can be unlocked using Syncfusion<sup>®</sup> registered login credential.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/xamarin/installation/web-installer/how-to-install) links for step-by-step installation guidelines.	