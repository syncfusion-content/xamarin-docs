---
layout: post
title: Number Formatting in Xamarin Numeric Entry control | Syncfusion<sup>®</sup>
description: Learn here all about Number Formatting support in Syncfusion<sup>®</sup> Xamarin Numeric Entry (SfNumericTextBox) control and more.
platform: Xamarin
