...
The `SfListView` allows displaying the paging by using the [SfDataPager](https://help.syncfusion.com/cr/xamarin/Syncfusion.SfDataGrid.XForms.DataPager.html) control. It can be performed through loading data dynamically into ItemsSource of the SfListView using OnDemandLoading event for the current page by setting the [SfDataPager.UseOnDemandPaging](https://help.syncfusion.com/cr/xamarin/Syncfusion.SfDataGrid.XForms.DataPager.SfDataPager.html#Syncfusion_SfDataGrid_XForms_DataPager_SfDataPager_UseOnDemandPaging) to `True`. By using the [SfDataPager.PageSize](https://help.syncfusion.com/cr/xamarin/Syncfusion.SfDataGrid.XForms.DataPager.SfDataPager.html#Syncfusion_SfDataGrid_XForms_DataPager_SfDataPager_PageSize) property, you can define the number of list items to be displayed in each page.
...
[How to highlight the tapped view in ItemTemplate in Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/9682/how-to-highlight-the-tapped-view-in-itemtemplate-in-xamarin-forms-listview-sflistview)                                                                                                                                                                                                                                                      
[How to access a named ListView inside a XAML DataTemplate in Xamarin.Forms (SfListView)](https://support.syncfusion.com/kb/article/9786/how-to-access-a-named-listview-inside-a-xaml-datatemplate-in-xamarin-forms-sflistview)                                                                                                                                                  
[How to edit the ListView tapped item in Xamarin.Forms (SfListView) using DataForm](https://support.syncfusion.com/kb/article/9817/how-to-edit-the-listview-tapped-item-in-xamarin-forms-sflistview-using-dataform)                                                                                                                                                                                            
[How to add or remove an item from Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/9835/how-to-add-or-remove-an-item-from-xamarin-forms-listview-sflistview)                                                                                                                                                                                    
[How to show Xamarin.Forms ListView (SfListView) in popup using Rg.Plugin.Popup framework](https://support.syncfusion.com/kb/article/9873/how-to-show-xamarin-forms-listview-sflistview-in-popup-using-rg-plugin-popup-framework?isInternalRefresh=False)                                                                                                                          
[How to set the font size for Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/10005/how-to-set-the-font-size-for-xamarin-forms-listview-sflistview)                                                                                                                                                                         
[How to improve performance when doing bulk changes in Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/10042/how-to-improve-performance-when-doing-bulk-changes-in-xamarin-forms-listview-sflistview)                                                                                                                                                                                                                                                                                                                                                                                                           
[How to dispose of children of ListView in Xamarin.Forms (SfListView)](https://support.syncfusion.com/kb/article/10037/how-to-dispose-of-children-of-listview-in-xamarin-forms-sflistview)                                                                                                                                                                                                                                                                                        
[How to make sound on tapping an item in Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/10227/how-to-make-sound-on-tapping-an-item-in-xamarin-forms-listview-sflistview)                                                                                                                                 
[How to apply the ListView item text color in Xamarin.Forms (SfListView)](https://support.syncfusion.com/kb/article/10250/how-to-apply-the-listview-item-text-color-in-xamarin-forms-sflistview)                                                                                                                                                                             
[How to share items source among Xamarin.Forms ListView with carousel page (SfListView)](https://support.syncfusion.com/kb/article/10282/how-to-share-items-source-among-xamarin-forms-listview-with-carousel-page-sflistview)                                                                                                                                                                                                                                                          
[How to enable compiled binding for Xamarin.Forms ListView (SfListView)](https://support.syncfusion.com/kb/article/10142/how-to-enable-compiled-binding-for-xamarin-forms-listview-sflistview)
