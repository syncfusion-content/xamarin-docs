...
**SfDataGrid.AutoGenerateColumnsMode** decides a way to create columns when [SfDataGrid.AutoGenerateColumns](http://help.syncfusion.com/cr/cref_files/xamarin/sfdatagrid/Syncfusion.SfDataGrid.XForms~Syncfusion.SfDataGrid.XForms.SfDataGrid~AutoGenerateColumns.html) is set to **true**. This enum type has the following four options.
