---
layout: post
title: Formatting String in Xamarin Range Slider control | Syncfusion<sup>®</sup>
description: Learn here all about Formatting String support in Syncfusion<sup>®</sup> Xamarin Range Slider (SfRangeSlider) control and more.
platform: Xamarin
control: RangeSlider
documentation: ug
---
