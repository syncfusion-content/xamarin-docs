...
layout: post
title: Badge Customization in Xamarin Badge View control | Syncfusion
description: Learn here all about Badge Customization support in Syncfusion Xamarin Badge View (SfBadgeView) control and more.
platform: xamarin
control: SfBadgeView
documentation: ug
