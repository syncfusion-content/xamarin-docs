...
layout: post
title: Precision Mode in Xamarin Rating control | Syncfusion<sup>®</sup>
description: Learn here all about Precision Mode support in Syncfusion<sup>®</sup> Xamarin Rating (SfRating) control and more.
platform: Xamarin
control: Rating
documentation: ug
