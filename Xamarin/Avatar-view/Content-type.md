...
You can add a custom user image by setting the `ImageSource` property. Refer to this [`documentation`](https://help.syncfusion.com/xamarin/SfAvatarView/getting-started).
