---
layout: post
title: Getting Started with Xamarin NumericUpDown control | Syncfusion<sup>®</sup>
description: Learn here about getting started with Syncfusion<sup>®</sup> Xamarin NumericUpDown (SfNumericUpDown) control, its elements and more.
platform: xamarin
