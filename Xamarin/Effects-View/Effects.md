---
layout: post
title: Effects in Xamarin Effects View control | Syncfusion<sup>®</sup>
description: Learn here all about Effects support in Syncfusion<sup>®</sup> Xamarin Effects View (SfEffectsView) control and more.
platform: xamarin
