 ...
 * When swiping in iOS, suddenly carousel swipe happened even if added gesture to carousel view. To swipe ListViewItem, touch and hold the item for some fraction of seconds (0.25 - 0.5 seconds) and then swipe. 
