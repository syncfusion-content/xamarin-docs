---
layout: post
title: Downloading Syncfusion Xamarin web installer - Syncfusion
description: Learn here about the how to download Syncfusion Xamarin web installer from our syncfusion website with license.
platform: Xamarin
...
# Downloading Syncfusion Xamarin web installer
...
4. After you've started the trial, go to the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page to get the latest version trial installer. You can generate the [unlock key](https://www.syncfusion.com/kb/8069/how-to-generate-unlock-key-for-essentials-studio-products) and [license key](https://help.syncfusion.com/xamarin/licensing/how-to-generate) here at any time before the trial period expires. (as shown in below screenshot.)
...
8. After downloading, the Syncfusion Xamarin web installer can be unlocked using Syncfusion registered login credential.
