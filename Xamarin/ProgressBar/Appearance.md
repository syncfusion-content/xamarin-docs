---
layout: post
title: Appearance in Xamarin ProgressBar control | Syncfusion&reg;
description: Learn here all about appearance support in Syncfusion&reg; Xamarin ProgressBar control, its elements and more.
platform: xamarin
control: ProgressBar
documentation: ug
---
