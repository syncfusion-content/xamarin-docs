...
2.	Select the **Essential UI Kit for Xamarin.Forms** from the **Solution Explorer** by right-clicking on your **Xamarin.Forms** project
	...
	![Syncfusion Essential UI Kit Context menu](esential-ui-kit-images/syncfusion-essential-ui-kit-context-menu.png)
...
3.	The Category dialogue box will then appear, with its pre-defined template.
	...
	![Add new item dialog box in Xamarin](essential-ui-kit-images/xamarin-add-New-Item-dialog-box.png)
...
5.	If you want to edit your page name, then rename and choose projects which you want to add references.
	...
	![Edit page Name](essential-ui-kit-images/xamarin-edit-page-name.png)
...
6.	The selected pages will be added along with View, View Model, Model classes, resource files and Syncfusion NuGet package reference,
	...
	![MVVM files in Xamarin](essential-ui-kit-images/xamarin-essential-ui-kit-mvvm-files.png)

	![Added NuGet in Xamarin](essential-ui-kit-images/xamarin-essential-ui-kit-add-nuget.png)

	![Added Resourcesn in Xamarin](essential-ui-kit-images/Xamarin-added-resources.png)
