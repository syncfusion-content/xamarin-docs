...
![Adding resx file for Pop-up](PopupLayout_images/PopUpAddingResxFile.png)
...
![resx file of Pop-up](PopupLayout_images/PopUpResxFile.png)
...
After setting the root/main page of the application in your App.Xaml.cs file of the PCL project, initialize a new instance of the `ResourceManager` class and set it to the [PopupLayoutResourceManager.Manager](https://help.syncfusion.com/cr/xamarin/Syncfusion.XForms.PopupLayoutResourceManager.html#Syncfusion_XForms_PopupLayoutResourceManager_Manager) property to look up into the resources with specified root name in the given assembly. Using `DependencyService`, call `SetLocale()` of the implemented interface with necessary language code as parameter.
...
public partial class App : Application
{
    public App()
    {
        ...
        {
            PopupLayoutResourceManager.Manager = new ResourceManager("GettingStarted.Resources.Syncfusion.SfPopupLayout.XForms", this.GetType().GetTypeInfo().Assembly);
