...
After installing [Essential Studio for Xamarin](https://www.syncfusion.com/downloads), you can find all the required assemblies in the installation folders, {Syncfusion Essential Studio Installed location} \Essential Studio\\{Version #}\Xamarin\lib.
