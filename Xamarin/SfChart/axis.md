...
[`ZoomFactor`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartAxis~ZoomFactor.html) defines the percentage of visible range from the total range of axis values. For instance, when the Range is from 0 to 100 and [`ZoomFactor`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartAxis~ZoomFactor.html) is 0.5, only 50 ranges are displayed, such as 0 to 50 or 50 to 100. 

[`ZoomPosition`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartAxis~ZoomPosition.html) defines the ranges of values that need to be displayed as a result of [`ZoomFactor`]. For the above scenario, when the [`ZoomPosition`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartAxis~ZoomPosition.html) is 0.25 then the Visible Range is from 25 to 75.

The value of [`ZoomFactor`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartAxis~ZoomFactor.html) and [`ZoomPosition`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.ChartAxis~ZoomPosition.html) must also fall within the value of 0 to 1. These can be set for both the Primary and Secondary Axes.
...
<chart:SfChart.PrimaryAxis>
    ...
    <chart:CategoryAxis ZoomFactor="0.3" ZoomPosition="0.1"/>
...
In [`DateTimeAxis`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.DateTimeAxis.html), you can apply auto scrolling delta value in years, months, days, hours, minutes, seconds and milliseconds by setting `AutoScrollingDeltaType` property.
...
[`SfChart`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.SfChart.html) provides a way to arrange multiple series inside the same chart area, giving the chart more space than x-axis and y-axis. These axes can be arranged in a stacking order or in a side by side pattern.

By default, all the series are plotted based on Primary and Secondary Axis. You can add more axes by adding additional axis to the series. There are two properties, `XAxis` and `YAxis` in all the series type which is used to provide Multiple axes support, except [`AccumulationSeries`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.SfChart.XForms.AccumulationSeries.html).
...
<chart:SfChart>
     ...
     <chart:SfChart.Series>
          ...
          <chart:ColumnSeries ItemsSource="{Binding ColumnData}" XBindingPath="Name" YBindingPath="Value"/>
     
	      <chart:LineSeries ItemsSource="{Binding LineData}" XBindingPath="Name" YBindingPath="Value">
...

{
     ...
     Series =
     {
         new ColumnSeries()
         {
               ItemsSource = viewModel.ColumnData,
         ...
         new LineSeries()
         {
               ItemsSource = viewModel.LineData,
