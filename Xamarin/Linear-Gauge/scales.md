...
layout: post
title: Scales in Xamarin Linear Gauge control | Syncfusion<sup>&reg;</sup>
description: Learn here all about Scales support in Syncfusion<sup>&reg;</sup> Xamarin Linear Gauge (SfLinearGauge) control and more.
platform: Xamarin
control: LinearGauge
documentation: ug
