...
* In Android, need to set approximate size to [SfListView.ItemSize](https://help.syncfusion.com/cr/cref_files/xamarin/sflistview/Syncfusion.SfListView.XForms~Syncfusion.ListView.XForms.SfListView~ItemSize.html) which matches measured size of each items to avoid the reverse scrolling when scroll to end of SfListView.
