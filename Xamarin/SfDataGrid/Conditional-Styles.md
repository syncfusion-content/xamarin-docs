...
SfDatagrid also allows you to apply styles for the GridCells in a column based on conditions by writing a converter for the property in [GridCell](http://help.syncfusion.com/cr/cref_files/xamarin/sfdatagrid/Syncfusion.SfDataGrid.XForms~Syncfusion.SfDataGrid.XForms.GridCell.html) for which conditional styles need to be applied.
