...
The [`OverlayColor`](https://help.syncfusion.com/cr/cref_files/xamarin/sfchart/Syncfusion.SfChart.XForms~Syncfusion.RangeNavigator.XForms.SfDateTimeRangeNavigator~OverlayColor.html) property of `SfDateTimeRangeNavigator` is used to visualize the unselected region of the range navigator. 
...
The deferred delay can be customized by using [`DeferredUpdateDelay`] property. 
