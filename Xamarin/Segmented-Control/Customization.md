---
layout: post
title: Customization in Xamarin Segmented Control | Syncfusion<sup>®</sup>
description: Learn here all about Customization support in Syncfusion<sup>®</sup> Xamarin Segmented Control (SfSegmentedControl) and more.
platform: Xamarin
