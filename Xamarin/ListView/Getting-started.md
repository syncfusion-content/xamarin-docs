...
The [DataSource](https://help.syncfusion.com/cr/xamarin/Syncfusion.DataSource.Portable~Syncfusion.DataSource.DataSource.html) gets the raw data and processes data operations such as sorting, filtering and grouping in SfListView. The data source of the ListView is set via the `ItemsSource` attribute.
