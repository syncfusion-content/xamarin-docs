---
layout: post
title: Localization in Xamarin Numeric Entry control | Syncfusion<sup>®</sup>
description: Learn here all about Localization support in Syncfusion<sup>®</sup> Xamarin Numeric Entry (SfNumericTextBox) control and more.
platform: Xamarin
