...
N> In this documentation we have generated ttf file by using metro studio and provide own icon text name as ”6” as like this[link](https://help.syncfusion.com/metro-studio/export-icon-font#customization) link. 
