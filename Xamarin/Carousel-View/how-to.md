...
description : Learn how to perform an operation while changing the carouselItem or Collection in Carousel in Syncfusion Carousel Control (SfCarousel) for Xamarin.
platform : Xamarin
control : Carousel
documentation : ug
---
